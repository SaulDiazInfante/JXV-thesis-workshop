...
\begin{document}
    ...
    \section{Introducci\'on}
        ...
        \input{./introduction/stochastic_epidemic_models.tex}
    ...
    \section{Propiedades del proceso souluci\'on}
        \input{Perturbation/existence-unicity-posivity}
    \section{%
        Umbral: %
        $   
            R_0 ^ S := 
        ...
        \input{./Perturbation/extinction.tex}
        \input{./Perturbation/persistence.tex}
        \input{Perturbation/stationary_distribution}
    \section{Ideas}
        \input{Perturbation/ideas}
\end{document}
